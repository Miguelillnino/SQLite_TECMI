...
import static com.tecmi.tutorialyoutube.R.*;
...
public class DataList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.activity_data_list);

        setTitle("Datos Registrados");
        tabla=(TableLayout) findViewById(id.tblayout);
        cargarDatos();
    }
    ...
    public void cargarDatos(){
        ...
        DBHelper admin = new DBHelper(this, "DBTECMI", null, 1);
        ...
        while(!fila.isAfterLast()){
           ...
           TextView codigo= (TextView)layout.findViewById(id.tvcodigo);
           TextView descripcion= (TextView)layout.findViewById(id.tvdescripcion);
           TextView precio= (TextView)layout.findViewById(id.tvprecio);
